...
#%%
model.plot_fourier(m_values=[3,50,100], n_samples=100)
...
synth_data_ARIMA = model.gen_ARIMA(p=1, d=0, q=0, n_samples=1000)
...
GAN_path = f'{os.getcwd()}\\GAN\\{data_name} Generator\\PM_epochs=1000_seq=85_batch=5.pth'

...
#%%
model.plot_fourier(m_values=[5,50,100], n_samples=100)
...
fourier_wass = model.wass_dist(synth_data_fourier, dec_places=4)
#%%
...
synth_data_ARIMA = model.gen_ARIMA(p=2, d=0, q=4, n_samples=1000)
...
ARIMA_wass = model.wass_dist(synth_data_ARIMA, dec_places=4)
...
cosmos_wass = model.wass_dist(synth_data_cosmos, dec_places=4)
...
GAN_path = f'{os.getcwd()}\\GAN\\{data_name} Generator\\{data_name}_epochs=501_seq=127_batch=13.pth'
...
GAN_wass = model.wass_dist(synth_data_GAN, dec_places=4)
